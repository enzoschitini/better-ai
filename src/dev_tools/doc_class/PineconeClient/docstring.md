...
class PineconeClient:
    ...
    Args:
        index_name (str): Nome do índice Pinecone a ser usado. Default é None.
        main_namespace (str): Namespace principal para operações. Default é None.
        global_namespace (str): Namespace global para operações. Default é None.
        embedding_model (str): Nome do modelo de embedding para usar. Default é None.
    ...
    def _init_pinecone(self) -> None:
        """
        Inicializa a conexão com o serviço Pinecone e seleciona o índice configurado.
        """
    ...
    def _init_embeddings(self, model_name: Optional[str] = None) -> None:
        """
        Inicializa o modelo de embeddings a ser utilizado para geração de vetores.
        
        Args:
            model_name (str): Nome do modelo de embedding a ser usado. Default é None, o que usa o padrão configurado.
        """
    ...
    def get_namespace(self, namespace: Optional[str] = None) -> str:
        """
        Resolve namespace padrão, retornando o especificado ou o principal configurado.
        
        Args:
            namespace (str): Namespace desejado. Default é None, que utiliza o namespace principal configurado.
        
        Returns:
            str: Namespace resolvido para uso na operação.
        """
    ...
    def create_vector_store(
        ...
        """
        Cria um VectorStore para ingestão ou busca de vetores em um namespace específico.
        
        Args:
            namespace (str): Namespace para o VectorStore. Default é None, usa o namespace principal.
            embedding_model (OpenAIEmbeddings): Modelo de embedding a ser usado. Default é None, usa o padrão inicializado.
        
        Returns:
            PineconeVectorStore: Instância do VectorStore configurada para o namespace e modelo escolhidos.
        """
