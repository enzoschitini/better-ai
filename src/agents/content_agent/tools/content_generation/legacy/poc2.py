...
if __name__ == "__main__":
    import time
    from agents.content_agent.tools.content_generation.test.example_requests import EXAMPLE_REQUESTS
    ...
    def generate_content():
        ...
        markdown_file = save_posts_markdown(
            ...
            output_file="src/agents/content_agent/tools/content_generation",
...
# python -m src.agents.content_agent.tools.content_generation.poc2